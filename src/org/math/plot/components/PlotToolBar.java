...
//        }
        ...
        //show or hide legend
        final JCheckBox showHideLengend = new JCheckBox("show/hide legend", true);
        ItemListener itemListener = new ItemListener(){
        	public void itemStateChanged(ItemEvent e) {
        		Object obj=e.getItem(); 
        		if(obj.equals(showHideLengend)){ 
        			if(showHideLengend.isSelected()){ 
        				plotCanvas.linkedLegendPanel.setVisible(true);
        				//System.out.println("ok"); 
        			}else{ 
        				plotCanvas.linkedLegendPanel.setVisible(false);
        ...
        showHideLengend.setSelected(true);
        showHideLengend.addItemListener(itemListener);
        
        add(showHideLengend,null);
